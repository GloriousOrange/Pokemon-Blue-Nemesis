...
RivalCounterTable:
	...
	db PIKACHU          ; #016 PIDGEY (FLYING)
	db MACHOP           ; #019 RATTATA (NORMAL)
	db VOLTORB          ; #021 SPEAROW (FLYING)
	...
	db ELECTABUZZ       ; #041 ZUBAT (FLYING)
	...
	db MAGNEMITE        ; #083 FARFETCHD (FLYING)
	db PIKACHU          ; #084 DODUO (FLYING)
	...
	db ELECTABUZZ       ; #142 AERODACTYL (FLYING)
