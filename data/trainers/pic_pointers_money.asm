...
TrainerPicAndMoneyPointers::
	...
	pic_money Rival1Pic,       3500 ; rival = Red's front sprite (Rival1Pic now INCBINs red.pic)
	...
	pic_money Rival2Pic,       6500 ; rival = Red's front sprite
	pic_money Rival3Pic,       9900 ; rival = Red's front sprite
