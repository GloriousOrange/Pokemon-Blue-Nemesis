...
; Custom Oak's Lab rival teams (teams 10-44) generated by scripts/gen_tables.py
	...
	db 5, GASTLY, 0       ; team 31
	db 5, WEEDLE, 0       ; team 32
	db 5, GEODUDE, 0      ; team 33
	db 5, MAGMAR, 0       ; team 34
	db 5, BELLSPROUT, 0   ; team 35
	db 5, JYNX, 0         ; team 36
	db 5, EXEGGCUTE, 0    ; team 37
	db 5, VENONAT, 0      ; team 38
	db 5, CUBONE, 0       ; team 39
	db 5, SEEL, 0         ; team 40
	db 5, HORSEA, 0       ; team 41
	db 5, DRATINI, 0      ; team 42
	db 5, SCYTHER, 0      ; team 43
	db 5, PINSIR, 0       ; team 44
