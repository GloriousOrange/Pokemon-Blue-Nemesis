...
; Route 24
	db 100, NIDOKING, ARBOK, WEEZING, VICTREEBEL, GENGAR, MUK, 0 ; NUGGET BRIDGE custom-move test
; Route 25
...
; Mt. Moon 1F
	...
	db 14, CLEFAIRY, 0
; Route 24
	db 100, PIDGEOT, FEAROW, DODRIO, AERODACTYL, ARTICUNO, DRAGONITE, 0 ; NUGGET BRIDGE custom-move test
	db 100, ALAKAZAM, HYPNO, MR_MIME, EXEGGUTOR, STARMIE, SLOWBRO, 0 ; NUGGET BRIDGE custom-move test
; Route 25
...
; Route 24/Route 25
	db 100, MACHAMP, PRIMEAPE, HITMONLEE, ONIX, GOLEM, RHYDON, 0 ; NUGGET BRIDGE custom-move test
; Route 24
	db 100, BLASTOISE, CHARIZARD, VENUSAUR, LAPRAS, JOLTEON, PINSIR, 0 ; NUGGET BRIDGE custom-move test
; Route 6
	db 20, SQUIRTLE, 0
