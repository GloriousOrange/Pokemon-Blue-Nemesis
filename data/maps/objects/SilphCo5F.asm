	...
	const_export SILPHCO5F_DEFENDER1
	const_export SILPHCO5F_DEFENDER2
	const_export SILPHCO5F_DEFENDER3
	...
	const_export SILPHCO5F_FLAVOR_ROCKET
	const_export SILPHCO5F_FLAVOR_SCIENTIST
...
; path. Exactly one of each pair is shown -- see SetFactionObjectsScript.
	object_event  8, 16, SPRITE_SCIENTIST, STAY, RIGHT, TEXT_SILPHCO5F_DEFENDER1, OPP_SCIENTIST, 27
	object_event 28,  4, SPRITE_SCIENTIST, STAY, UP, TEXT_SILPHCO5F_DEFENDER2, OPP_SCIENTIST, 28
	object_event 18, 10, SPRITE_SUPER_NERD, STAY, UP, TEXT_SILPHCO5F_DEFENDER3, OPP_SUPER_NERD, 129
	...
	object_event 11,  9, SPRITE_ROCKET, STAY, RIGHT, TEXT_SILPHCO5F_FLAVOR_ROCKET
	object_event 12,  9, SPRITE_SCIENTIST, STAY, LEFT, TEXT_SILPHCO5F_FLAVOR_SCIENTIST
