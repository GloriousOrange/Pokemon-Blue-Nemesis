...
SilphCo8F_Object:
	...
	object_event  6,  2, SPRITE_ROCKET, STAY, RIGHT, TEXT_SILPHCO8F_FLAVOR_ROCKET, OPP_ROCKET, 35
	object_event  7,  2, SPRITE_SCIENTIST, STAY, LEFT, TEXT_SILPHCO8F_FLAVOR_SCIENTIST, OPP_SCIENTIST, 9
