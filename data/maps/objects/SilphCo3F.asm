	...
	const_export SILPHCO3F_DEFENDER1
	const_export SILPHCO3F_HYPER_POTION
	const_export SILPHCO3F_FLAVOR_ROCKET
	const_export SILPHCO3F_FLAVOR_SCIENTIST
...
; path. Exactly one of each pair is shown -- see SetFactionObjectsScript.
	object_event 20,  7, SPRITE_SCIENTIST, STAY, LEFT, TEXT_SILPHCO3F_DEFENDER1, OPP_SCIENTIST, 24
	object_event  8,  5, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO3F_HYPER_POTION, HYPER_POTION
	object_event 22,  8, SPRITE_ROCKET, STAY, RIGHT, TEXT_SILPHCO3F_FLAVOR_ROCKET
	object_event 23,  8, SPRITE_SCIENTIST, STAY, LEFT, TEXT_SILPHCO3F_FLAVOR_SCIENTIST
