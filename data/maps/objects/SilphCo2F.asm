...
SilphCo2F_Object:
	...
	object_event 11,  3, SPRITE_ROCKET, STAY, RIGHT, TEXT_SILPHCO2F_FLAVOR_ROCKET, OPP_ROCKET, 23
	object_event 12,  3, SPRITE_SCIENTIST, STAY, LEFT, TEXT_SILPHCO2F_FLAVOR_SCIENTIST, OPP_SCIENTIST, 2
