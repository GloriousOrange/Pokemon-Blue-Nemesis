	...
	const_export POWERPLANT_TM_CONFUSE_RAY
...
PowerPlant_Object:
	...
	object_event  4,  9, SPRITE_ROCKER, STAY, UP, TEXT_POWERPLANT_ZAPDOS, OPP_JUGGLER, 9 ; ZAPDOS's keeper, at the bird's old perch
	object_event  7, 25, SPRITE_POKE_BALL, STAY, NONE, TEXT_POWERPLANT_TM_CONFUSE_RAY, TM_CONFUSE_RAY
