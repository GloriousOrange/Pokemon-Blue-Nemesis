	...
	const_export SILPHCO10F_DEFENDER1
	...
	const_export SILPHCO10F_FLAVOR_ROCKET
	const_export SILPHCO10F_FLAVOR_SCIENTIST
...
; path. Exactly one of each pair is shown -- see SetFactionObjectsScript.
	object_event  1,  9, SPRITE_SCIENTIST, STAY, RIGHT, TEXT_SILPHCO10F_DEFENDER1, OPP_SCIENTIST, 38
	...
	object_event 11, 15, SPRITE_ROCKET, STAY, RIGHT, TEXT_SILPHCO10F_FLAVOR_ROCKET
	object_event 12, 15, SPRITE_SCIENTIST, STAY, LEFT, TEXT_SILPHCO10F_FLAVOR_SCIENTIST
