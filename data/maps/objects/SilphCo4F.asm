	...
	const_export SILPHCO4F_DEFENDER1
	const_export SILPHCO4F_DEFENDER2
	const_export SILPHCO4F_FULL_HEAL
	const_export SILPHCO4F_MAX_REVIVE
	const_export SILPHCO4F_ESCAPE_ROPE
	const_export SILPHCO4F_FLAVOR_ROCKET
	const_export SILPHCO4F_FLAVOR_SCIENTIST
...
; path. Exactly one of each pair is shown -- see SetFactionObjectsScript.
	object_event  9, 14, SPRITE_SCIENTIST, STAY, RIGHT, TEXT_SILPHCO4F_DEFENDER1, OPP_SCIENTIST, 25
	object_event 26, 10, SPRITE_SCIENTIST, STAY, UP, TEXT_SILPHCO4F_DEFENDER2, OPP_SCIENTIST, 26
	...
	object_event  8,  2, SPRITE_ROCKET, STAY, RIGHT, TEXT_SILPHCO4F_FLAVOR_ROCKET
	object_event  9,  2, SPRITE_SCIENTIST, STAY, LEFT, TEXT_SILPHCO4F_FLAVOR_SCIENTIST
