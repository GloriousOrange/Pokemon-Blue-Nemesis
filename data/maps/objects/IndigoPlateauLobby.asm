	...
	const_export INDIGOPLATEAULOBBY_MEGAN
	...
	const_export INDIGOPLATEAULOBBY_ROCKET_MERCHANT
...
IndigoPlateauLobby_Object:
	...
	object_event  4,  9, SPRITE_GIRL, STAY, RIGHT, TEXT_INDIGOPLATEAULOBBY_MEGAN ; MEGAN: heals, and offers a last optional sparring match before the Elite Four
	...
	object_event 11,  9, SPRITE_ROCKET, STAY, DOWN, TEXT_INDIGOPLATEAULOBBY_ROCKET_MERCHANT ; quartermaster; only trades with ROCKET loyalists
