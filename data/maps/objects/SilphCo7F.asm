	...
	const_export SILPHCO7F_DEFENDER1
	const_export SILPHCO7F_DEFENDER2
	const_export SILPHCO7F_DEFENDER3
...
; path. Exactly one of each pair is shown -- see SetFactionObjectsScript.
	object_event 13,  1, SPRITE_SCIENTIST, STAY, DOWN, TEXT_SILPHCO7F_DEFENDER1, OPP_SCIENTIST, 31
	object_event 20,  2, SPRITE_SCIENTIST, STAY, LEFT, TEXT_SILPHCO7F_DEFENDER2, OPP_SCIENTIST, 32
	object_event 19, 14, SPRITE_SCIENTIST, STAY, RIGHT, TEXT_SILPHCO7F_DEFENDER3, OPP_SCIENTIST, 33
