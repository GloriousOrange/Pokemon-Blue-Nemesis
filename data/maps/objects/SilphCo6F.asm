	...
	const_export SILPHCO6F_DEFENDER1
	const_export SILPHCO6F_DEFENDER2
	const_export SILPHCO6F_HP_UP
	const_export SILPHCO6F_X_ACCURACY
	const_export SILPHCO6F_FLAVOR_ROCKET
	const_export SILPHCO6F_FLAVOR_SCIENTIST
...
; path. Exactly one of each pair is shown -- see SetFactionObjectsScript.
	object_event 17,  3, SPRITE_SCIENTIST, STAY, RIGHT, TEXT_SILPHCO6F_DEFENDER1, OPP_SCIENTIST, 29
	object_event 14, 15, SPRITE_SCIENTIST, STAY, LEFT, TEXT_SILPHCO6F_DEFENDER2, OPP_SCIENTIST, 30
	...
	object_event  8,  6, SPRITE_ROCKET, STAY, RIGHT, TEXT_SILPHCO6F_FLAVOR_ROCKET
	object_event  9,  6, SPRITE_SCIENTIST, STAY, LEFT, TEXT_SILPHCO6F_FLAVOR_SCIENTIST
