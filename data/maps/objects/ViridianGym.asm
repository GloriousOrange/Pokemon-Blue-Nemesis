...
ViridianGym_Object:
	...
	def_object_events
	object_event  2,  1, SPRITE_ROCKER, STAY, DOWN, TEXT_VIRIDIANGYM_GIOVANNI, OPP_TAMER, 1
	...
	object_event 10,  7, SPRITE_ROCKER, STAY, DOWN, TEXT_VIRIDIANGYM_ROCKER1, OPP_JUGGLER, 14
	...
	object_event  2, 16, SPRITE_ROCKER, STAY, RIGHT, TEXT_VIRIDIANGYM_ROCKER2, OPP_JUGGLER, 15
	object_event  6,  5, SPRITE_COOLTRAINER_M, STAY, DOWN, TEXT_VIRIDIANGYM_COOLTRAINER_M3, OPP_COOLTRAINER_M, 1
	object_event 16, 15, SPRITE_GIRL, STAY, DOWN, TEXT_VIRIDIANGYM_GYM_GUIDE
