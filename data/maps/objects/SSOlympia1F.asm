	...
	const_export SSOLYMPIA1F_YOUNGSTER
	const_export SSOLYMPIA1F_LASS
...
SSOlympia1F_Object:
	...
	object_event 26,  2, SPRITE_YOUNGSTER, STAY, DOWN, TEXT_SSOLYMPIA1F_YOUNGSTER, OPP_YOUNGSTER, 15
	object_event  3, 14, SPRITE_COOLTRAINER_F, STAY, DOWN, TEXT_SSOLYMPIA1F_LASS, OPP_LASS, 20
