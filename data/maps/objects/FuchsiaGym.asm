...
FuchsiaGym_Object:
	...
	object_event  3,  5, SPRITE_ROCKER, STAY, UP, TEXT_FUCHSIAGYM_ROCKER4, OPP_JUGGLER, 11
	object_event  8,  2, SPRITE_ROCKER, STAY, DOWN, TEXT_FUCHSIAGYM_ROCKER5, OPP_JUGGLER, 12
	object_event  2,  7, SPRITE_ROCKER, STAY, LEFT, TEXT_FUCHSIAGYM_ROCKER6, OPP_JUGGLER, 4
	object_event  7, 15, SPRITE_GIRL, STAY, DOWN, TEXT_FUCHSIAGYM_GYM_GUIDE
