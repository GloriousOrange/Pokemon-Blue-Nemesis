...
; Out on the bow deck. Appended last, which lands him on object id 6 -- exactly
; where `def_trainers 4` has counted to after the two SAILORs, so his header and
; his event bit line up with no juggling. Cell verified reachable and clear.
	object_event  7,  6, SPRITE_RED, STAY, DOWN, TEXT_SSANNEBOW_ASH, OPP_ASH, 4
