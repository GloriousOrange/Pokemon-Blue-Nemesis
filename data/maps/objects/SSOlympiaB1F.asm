	...
	const_export SSOLYMPIAB1F_ROCKET1
	const_export SSOLYMPIAB1F_ROCKET2
...
SSOlympiaB1F_Object:
	...
	object_event 10,  3, SPRITE_ROCKET, STAY, DOWN, TEXT_SSOLYMPIAB1F_ROCKET1, OPP_ROCKET, 48
	object_event 20,  4, SPRITE_ROCKET, STAY, DOWN, TEXT_SSOLYMPIAB1F_ROCKET2, OPP_ROCKET, 49
