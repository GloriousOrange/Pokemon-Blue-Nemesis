	...
	const_export SSOLYMPIA2F_BIKER
	const_export SSOLYMPIA2F_CUEBALL
...
SSOlympia2F_Object:
	...
	object_event 36,  6, SPRITE_BIKER, STAY, DOWN, TEXT_SSOLYMPIA2F_BIKER, OPP_BIKER, 17
	object_event 37, 13, SPRITE_BIKER, STAY, DOWN, TEXT_SSOLYMPIA2F_CUEBALL, OPP_CUE_BALL, 10
