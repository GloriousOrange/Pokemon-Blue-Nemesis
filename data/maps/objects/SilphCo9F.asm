...
SilphCo9F_Object:
	...
	object_event  5, 14, SPRITE_ROCKET, STAY, RIGHT, TEXT_SILPHCO9F_FLAVOR_ROCKET, OPP_ROCKET, 37
	object_event  6, 14, SPRITE_SCIENTIST, STAY, LEFT, TEXT_SILPHCO9F_FLAVOR_SCIENTIST, OPP_SCIENTIST, 10
