	...
	const_export POKEMONMANSION2F_LAB_SCIENTIST_1
	const_export POKEMONMANSION2F_LAB_SCIENTIST_2
...
PokemonMansion2F_Object:
	...
	object_event 22, 17, SPRITE_SCIENTIST, STAY, DOWN, TEXT_POKEMONMANSION2F_LAB_SCIENTIST_1, OPP_SCIENTIST, 15
	object_event 22, 21, SPRITE_SCIENTIST, STAY, DOWN, TEXT_POKEMONMANSION2F_LAB_SCIENTIST_2, OPP_SCIENTIST, 16
