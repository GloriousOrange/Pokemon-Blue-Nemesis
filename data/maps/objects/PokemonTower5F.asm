...
; Speed-testing kit: the sight-triggered channelers face away from their
; normal watch direction so they don't ambush-battle the tester every run.
; Same object count/order either way -- just the facing byte differs -- so
; this doesn't renumber anything or touch existing saves.
IF DEF(_SPEEDTEST)
	object_event 17,  7, SPRITE_CHANNELER, STAY, RIGHT, TEXT_POKEMONTOWER5F_CHANNELER2, OPP_CHANNELER, 14
	object_event 14,  3, SPRITE_CHANNELER, STAY, RIGHT, TEXT_POKEMONTOWER5F_CHANNELER3, OPP_CHANNELER, 16
	object_event  6, 10, SPRITE_CHANNELER, STAY, LEFT, TEXT_POKEMONTOWER5F_CHANNELER4, OPP_CHANNELER, 17
	object_event  9, 16, SPRITE_CHANNELER, STAY, LEFT, TEXT_POKEMONTOWER5F_CHANNELER5, OPP_CHANNELER, 18
ELSE
