...
MapHeaderBanks::
	...
	db BANK(ArchipelagoCave4F_h) ; ARCHIPELAGO_CAVE_4F (was CERULEAN_TRASHED_HOUSE_COPY)
	...
	db BANK(OriginIsle_h) ; ORIGIN_ISLE (was UNUSED_MAP_69)
	db BANK(VerdantIsle_h) ; VERDANT_ISLE (was UNUSED_MAP_6A)
	db BANK(MiasmaIsle_h) ; MIASMA_ISLE (was UNUSED_MAP_6B)
	db BANK(VictoryRoad1F_h)
	db BANK(SageIsle_h) ; SAGE_ISLE (was UNUSED_MAP_6D)
	db BANK(EmberIsle_h) ; EMBER_ISLE (was UNUSED_MAP_6E)
	db BANK(HavenIsle_h) ; HAVEN_ISLE (was UNUSED_MAP_6F)
	db BANK(ApexIsle_h) ; APEX_ISLE (was UNUSED_MAP_70)
