MapSongBanks::
	...
	db MUSIC_CINNABAR, BANK(Music_Cinnabar) ; BATTLE_ISLAND
	...
	db MUSIC_DUNGEON1, BANK(Music_Dungeon1) ; ARCHIPELAGO_CAVE_4F -- the sparsest
	; cave theme in the game; the grotto is meant to feel abandoned
	...
	db MUSIC_CINNABAR, BANK(Music_Cinnabar) ; BATTLE_ISLAND_HOUSE
