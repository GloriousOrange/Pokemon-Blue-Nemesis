MoveSoundTable:
	...
	db SFX_BATTLE_0B,          $00, $80 ; METRONOME2
	db SFX_BATTLE_0B,          $00, $80 ; CARRION_WIND
	db SFX_BATTLE_0B,          $00, $80 ; BLIGHT_VOMIT
	...
	db SFX_TRAINER_APPEARED,   $00, $ff ; JACKPOT (Pay Day coin-jingle sfx)
