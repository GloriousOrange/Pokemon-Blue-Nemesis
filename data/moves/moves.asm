...
; Characteristics of each move.
	...
	move MIMIC,        MIMIC_EFFECT,                 0, NORMAL,       100, 35
	...
	move CARRION_WIND, CARRION_WIND_EFFECT,          0, POISON,        85,  1
	...
	move TELEKINESIS,  TWO_TO_FIVE_ATTACKS_EFFECT,  30, PSYCHIC_TYPE,  85, 10
