	...
	db PSY_CHOP, POUND, NO_MOVE, NO_MOVE ; level 1 learnset (Psy Chop added for starter STAB)
	...
	tmhm MEGA_PUNCH, RAZOR_WIND, SWORDS_DANCE, WHIRLWIND, MEGA_KICK,  \
	     ...
	     MIMIC, DOUBLE_TEAM, REFLECT, METRONOME, SELFDESTRUCT,  \
	     ...
	     FLY, SURF, STRENGTH, FLASH, UNUSED,  \
	     ROCK_THROW
	; end
