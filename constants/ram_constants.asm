...
; wPostGameMisc bits (bit 0 = arena Giovanni defeated, DEF'd in its own script)
...
DEF DIFFICULTY_HARD   EQU 2 ; cannot use items in battle; Megan gives nothing until Victory Road
