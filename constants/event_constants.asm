...
; Lavender Town events
	...
	const_skip 3
	const EVENT_BEAT_GENERAL_MATHUS
	const_skip
	...
	const_skip 13
	const EVENT_GIOVANNI_SENT_TO_TOWER
	const EVENT_GOT_NOCTURN
	const EVENT_REPORTED_NOCTURN
...
; Route 10 events
	...
	const EVENT_BEAT_ROUTE_10_ASH ; from this block's padding, no enum shift
	const_skip 1
...
; Mt. Moon events
	...
	const EVENT_BEAT_MT_MOON_1_TRAINER_7 ; from this block's own padding, no enum shift
...
; Seafoam Islands events
	...
	const EVENT_STARTER_ALIVE_BEFORE_RIVAL2
	const EVENT_STARTER_BECAME_ASHES
	const EVENT_STARTER_RESURRECTED
	const EVENT_RIVAL_STARTER_DIED
	const EVENT_TYRANIS_ENCOUNTERED
	const_skip 3
	const EVENT_BEAT_ROUTE1_MEGAN
...
; across its 10 decks, plus the deck rival superboss.
	...
	const EVENT_GOT_LANDO_SPEEDTEST_MONS
	const EVENT_GOT_JOSH_SPEEDTEST_MONS
